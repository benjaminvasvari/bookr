...
public class staffPanelDTO {
    ...
    public static class getStaffDashboardTodayAppointmentsDTO {
        private Integer id;
        private String startTime;
        private String endTime;
        private String status;
        ...
        public getStaffDashboardTodayAppointmentsDTO(Integer id, String startTime, String endTime, String status, Double price, String currency, String serviceName, Integer durationMinutes, String clientName, String clientPhone, String clientEmail) {
            this.id = id;
            this.startTime = startTime;
            this.endTime = endTime;
            this.status = status;
    ...
    public static class getServicesByCompanyIdForStaffDTO {
        private Integer id;
        private String name;
        private String description;
        private Integer durationMinutes;
        ...
        public getServicesByCompanyIdForStaffDTO(Integer id, String name, String description, Integer durationMinutes, Double price, String currency, Boolean isActive, String categories, Boolean isAssigned) {
            this.id = id;
            this.name = name;
            this.description = description;
            this.durationMinutes = durationMinutes;
