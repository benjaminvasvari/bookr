...
--
-- Host: localhost:3307
-- Generation Time: Feb 24, 2026 at 09:58 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getSalesRevenueChart` (IN `companyIdIN` INT, IN `periodIN` ENUM('week','month','year'))   BEGIN
    ...
    ELSE
        SELECT
            ...
            DATE_FORMAT(`d`.`month`, '%Y-%m')  AS `day_name`,
...
(62, 2, 'client', 2, 1, 'jungle@jungle.hu', 'user', 'login', NULL, NULL, '2026-02-23 12:43:14'),
(63, 2, 'owner', 2, 1, 'jungle@jungle.hu', 'user', 'login', NULL, NULL, '2026-02-23 13:13:08'),
(64, 2, 'owner', 2, 1, 'jungle@jungle.hu', 'user', 'login', NULL, NULL, '2026-02-24 09:08:08');
...
(2, '5b5ce1aa-1027-11f1-afc2-2178f5682584', 'Tulaj', 'Jungle', 'jungle@jungle.hu', '$argon2id$v=19$m=65536,t=3,p=1$7gayZE9rh1QYR2KBE+urgg$WPksHWfoAw41UQYIVoGx914oP/VC72tKCepKzYhb0Zw', '+36302433894', 1, '2026-02-22 20:47:44', '2026-02-22 21:39:33', NULL, 0, '2026-02-24 10:08:08', '2026-02-22 20:48:36', 1, 0, NULL, NULL, NULL),
